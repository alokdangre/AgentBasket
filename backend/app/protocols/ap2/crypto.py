...
class AP2KeySet:
    ...
    def from_settings(cls, settings: Settings) -> AP2KeySet:
        values = (
            ...
            settings.ap2_trusted_surface_private_key_pem,
        ...
        merchant_pem, surface_pem, processor_pem = (
        ...
        return cls(
            ...
            trusted_surface=AP2Signer.from_pem(
                settings.ap2_trusted_surface_issuer,
                settings.ap2_trusted_surface_key_id,
                surface_pem,
            ),
